...
export default function DashboardPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-200">
      <div className="relative flex w-[390] flex-col overflow-hidden bg-white shadow-2xl" style={{ minHeight: "100dvh", maxHeight: "100dvh" }}>
        {/* Header */}
              ...
              {days.map((day) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "flex h-[88] w-[72] shrink-0 flex-col items-center justify-center rounded-2xl border transition-all",
                      isActive
        ...
        <div className="absolute bottom-0 left-0 right-0 flex items-center justify-around bg-black py-3">
          <button
            ...
            className={cn(
              "flex flex-col items-center gap-1 px-8 py-1 transition-colors",
