...
export default function WelcomePage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center md:bg-neutral-200 md:py-10">
      <div className="relative flex w-full flex-col bg-white min-h-screen md:min-h-0 md:w-[390] md:h-[860] md:rounded-[2rem] md:shadow-2xl md:overflow-hidden">
        {/* Header */}
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8 gap-7">
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <p className="text-sm text-slate-500 leading-relaxed max-w-[260]">
              Your payment was successful. You are now a member of our speaking
              club.
            </p>
          </div>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 w-full max-w-[280] rounded-full bg-sky-500 py-4 text-sm font-bold text-white shadow-lg hover:bg-sky-600 transition-colors"
          >
