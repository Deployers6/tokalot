...
export function AdminMobileNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-white/10 bg-[#092229] px-4 pb-[calc(0.75rem+env(safe-area-inset-bottom))] pt-3 backdrop-blur lg:hidden">
          ...
          return (
            <Link
              ...
              className={`flex min-w-0 flex-1 flex-col items-center gap-1 rounded-2xl px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.22em] transition ${
                active ? "bg-[#07171d] text-[#FFFFFF]" : "text-slate-500"
              }`}
            >
